...
//Circle circle1 = new Circle("빨강", new Point(10, 20), 5);


//
////Triangle triangle1 = new Triangle("초록", new Point(10, 1), new Point(1, 20),
////    new Point(10, 20)); // 색, 점1, 점2, 점3
...
//  Circle(String color, Point x1, Point y1, int radius) {
