...
//
//    ss.addShape(new Elipse("노랑", new Point(10,10), new Point(20,20), 30));
//    ss.addShape(new Elipse("베이지", 12,21,13,31,20));
//
//
//
//    ss.drawAll();
...
//////
//////  } 이렇게 쓰는거랑 this.color=color; 이렇게 쓰는거의 차이는?
//
//
//
